...
class Config:
    ...
    def _path_suitable_for_server(self):
        ...
        if self.config["server"] == "desktop":
            self.config["log_dir"] = "/content/drive/MyDrive/desktop/logdirs"
            self.config["model_dir"] = "/content/drive/MyDrive/desktop/models"
        if self.config["server"] == "local":
            self.config["log_dir"] = "/content/drive/MyDrive/local/logdirs"
            self.config["model_dir"] = "/content/drive/MyDrive/local/models"
        elif self.config["server"] == "ls15":
            self.config["log_dir"] = "/content/drive/MyDrive/ls15/logdirs"
            self.config["model_dir"] = "/content/drive/MyDrive/ls15/models"
        elif self.config["server"] == "ls16":
            self.config["log_dir"] = "/content/drive/MyDrive/ls16/logdirs"
            self.config["model_dir"] = "/content/drive/MyDrive/ls16/models"
        elif self.config["server"] == "lab_center":
            self.config["log_dir"] = "/content/drive/MyDrive/lab_centre/logdirs"
            self.config["model_dir"] = "/content/drive/MyDrive/lab_centre/models"
        else:
