...
input_channel = 3
trainset = dataset.Skin7(root="/content/drive/MyDrive/Colab_Notebooks/", iter_fold=iter_fold, train=True,
                         transform=train_transform)
valset = dataset.Skin7(root="/content/drive/MyDrive/Colab_Notebooks/", iter_fold=iter_fold, train=False,
